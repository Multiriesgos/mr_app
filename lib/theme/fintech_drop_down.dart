...
class FinTechDropDown extends StatefulWidget {
  const FinTechDropDown({super.key, 
    this.initialOption,
    this.hintText,
  ...
  @override
  State<FinTechDropDown> createState() => _FinTechDropDownState();
}

class _FinTechDropDownState extends State<FinTechDropDown> {
